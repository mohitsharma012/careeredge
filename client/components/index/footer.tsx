        ...
        <>
            <section className="py-10 bg-gray-50 sm:pt-16 lg:pt-24">
                <div className="px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl">
                    <div className="grid grid-cols-2 md:col-span-3 lg:grid-cols-6 gap-y-16 gap-x-12">
                        <div className="col-span-2 md:col-span-3 lg:col-span-2 lg:pr-8">
                            ...
                            <Link href={"/"} className="flex items-center gap-2">
                                <Brain className="h-7 w-7 text-custom-dark gradient" />
                                <span className="font-bold text-2xl"> {COMPANY_NAME} </span>
                            </Link>

                            <p className="text-base leading-relaxed text-gray-600 mt-4"> Upload your resume, analyze job descriptions, and get an AI-enhanced CV tailored for success.</p>
                        ...
                        <div>
                            ...
                            <ul className="mt-6 space-y-4">
                                <li>
                                    <a href="#" title="" className="flex text-base text-black transition-all duration-200 hover:text-blue-600 focus:text-blue-600"> Articles </a>
                                </li>

                                <li>
                                    <a href="#" title="" className="flex text-base text-black transition-all duration-200 hover:text-blue-600 focus:text-blue-600"> Resume Examples </a>
                                </li>
                    ...
                    <p className="text-sm text-center text-gray-600">© Copyright 2021, All Rights Reserved by {COMPANY_NAME}</p>
                </div>
            </section>
